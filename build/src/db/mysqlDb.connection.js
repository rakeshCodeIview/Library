...
var mysqlConstant = require('../config/config');
var mysqlDbConnection = /** @class */ (function () {
    ...
    mysqlDbConnection.prototype.mysqlconnect = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.connection.connect(function (err) {
                    if (!!err)
                        console.log(chalk_1.default.yellow.bgRed.bold(err));
                    else
                        console.log(chalk_1.default.whiteBright.bgBlue.bold('Database connected'));
                });
                return [2 /*return*/];
            });
        });
    };
    mysqlDbConnection.prototype.Query = function (query) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
